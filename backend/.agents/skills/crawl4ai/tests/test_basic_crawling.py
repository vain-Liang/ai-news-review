...
async def test_basic_crawl():
    ...
    browser_config = BrowserConfig(headless=True, viewport_width=1920, viewport_height=1080, user_agent="custom-agent")

    crawler_config = CrawlerRunConfig(page_timeout=30000, screenshot=True, remove_overlay_elements=True)
